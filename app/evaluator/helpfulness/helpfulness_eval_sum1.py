...
if __name__ == "__main__":
    ...
    # ---- mistral
    # main_eval_summary("M_AutoNUS", summary_evaluator, "mistral")
    # main_eval_summary("M_RPAP", summary_evaluator, "mistral")
    # main_eval_summary("M_Vlrdev", summary_evaluator, "mistral")
